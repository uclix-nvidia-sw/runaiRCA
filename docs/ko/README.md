...
| `typedb.ingest.requireReview`                  | 기본값 `false`에서는 적격 resolved 인시던트를 적재합니다. 운영자 승인 인시던트로 그래프 적재를 제한하려면 `true`로 설정하세요. |
