...
- RCA 보고서: 구조화되어 훑어보기 쉬운 보고서 뷰. 한국어 지원 폰트, GFM 표, 인시던트 id와
  페이지 번호가 담긴 페이지 푸터를 갖춘 스타일드 Word(`.docx`) 인시던트 보고서로 내보낼 수 있습니다.
- 유사 인시던트: dense RCA-content 매칭으로 찾은 과거의 닮은 인시던트를 family와 workload
  identity로 재랭킹해 표시.
